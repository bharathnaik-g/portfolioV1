        ...
        <div className="flex justify-center">
          ...
          <div className="text-center">
            ...
            <div className="relative inline-block">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-purple-500/20 blur-[160px] rounded-full"></div>
              ...
              <div className="absolute left-0 right-0 bottom-0 h-[3px] bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400"></div>
    ...
    >
      ...
      <div className="max-w-[900px] mx-auto px-10 text-center">
        ...
        <p className="text-gray-400 text-lg leading-relaxed">
          ...
          I'm Bharath Naik G, a full-stack developer focused on building modern web applications
          and integrating Generative AI into practical systems.

          My interests span across AI-powered applications,
          scalable software architecture, and cybersecurity.
